...
public class automata2 extends Fragment {
    private Button mRun;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.automata2_layout, container, false);
        ...
        mRun.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer.equals("10") || answer.equals("100") || answer.equals("10010")) {
...
//            @Override
//            public void onClick(View view) {
//                ((AutomataSimulatorActivity)getActivity()).setViewPager(1);
//            }
//        }));
