...
public class automata3 extends Fragment {
    private Button mRun;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.automata3_layout, container, false);
        ...
        mRun.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer.equals("aabba") || answer.equals("aabbba") || answer.equals("aaa")) {
...
//            @Override
//            public void onClick(View view) {
//                ((AutomataSimulatorActivity)getActivity()).setViewPager(2);
//            }
//        }));
