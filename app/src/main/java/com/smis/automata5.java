...
public class automata5 extends Fragment {
    private Button mRun;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.automata5_layout, container, false);
...
//        mNext = view.findViewById(R.id.nextBtn);
        ...
        mRun.setOnClickListener((new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (answer.equals("a,ba") || answer.equals("a,baa") || answer.equals("a,babab") || answer.equals("a,bab")) {
